...
public class MM1SJNsimulator {
	 ...
	 * 
	 * @return matrice di tempi medi spesi in coda per ogni classe di priorit� (il valore � definito da codice pari a 40) per ogni step di simulazione
	 */
	public double[][] run(){
		int step=0;
	...
	/**
	 * Metodo per la determinazione della classe di priorit� in funzione del tempo di servizio
	 * 
	 * @param theta tempo di servizio
	 * @return classe di priorit� relativa al tempo di servizio indicato
	 */
